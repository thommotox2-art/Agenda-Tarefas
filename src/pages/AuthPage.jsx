        ...
        <div className="bg-bg-surface py-6 px-4 shadow rounded-2xl sm:rounded-xl sm:py-8 sm:px-10 border border-border">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full rounded-md border border-border bg-bg-main px-3 py-2 text-text-primary focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full justify-center rounded-md border border-transparent bg-accent py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-accent-hover focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-bg-surface disabled:opacity-50 transition-colors"
            >
